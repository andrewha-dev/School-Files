...
public class Pair<T>
{
  ...
  /**
   * Determine if either element of this <tt>Pair</tt> is equal to the argument.
   * @param e the object to compare to the elements of this <tt>Pair</tt>
   * @return the first element of this <tt>Pair</tt> found equal to <tt>e</tt>,
   * <tt>null</tt> if neither element is equal to <tt>e</tt>
   */
