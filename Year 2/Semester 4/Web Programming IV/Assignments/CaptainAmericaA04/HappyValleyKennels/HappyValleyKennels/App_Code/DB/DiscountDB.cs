...
namespace HappyValleyKennels.App_Code.DB
{
    ...
    {
        //Delete HVK_PET_RESERVATION_DISCOUNT Rows where PR_PET_RES_NUMBER is something a res that needs to be deleted
        //Used in Conjunction with getAllPetResNumber() inside PetReservationDB into the PR_PET_RES_NUMBER parameter
        public void deletePetDiscountRow(int _PR_PET_RES_NUMBER)
        {
