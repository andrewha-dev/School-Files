    ...
    fs.open(fullpath,'r',function(err, fd) {
        if (!err) {
            ...
            fs.readFile(fullpath, 'utf-8', function (err, data) {
                ...
                fs.appendFile("log.txt",  basename+ extension+ '\r' , (err)=>{
            ...
            if (err.code == "ENOENT") {
                ...
                fs.readFile("webbase/errorpages/404.html", 'utf-8', function(err, data){
                    response.end(data);
                ...
                fs.readFile("webbase/errorpages/500.html", 'utf-8', function(err, data){
                    response.end(data);
